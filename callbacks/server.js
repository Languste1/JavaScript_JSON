// go to directory you want to start the server.js in your terminal
// example: C:\JavaScriptKurs\JSON\callbacks\
// then execute: node server.js
// server should be running now! if you need you can change the port in line 13
